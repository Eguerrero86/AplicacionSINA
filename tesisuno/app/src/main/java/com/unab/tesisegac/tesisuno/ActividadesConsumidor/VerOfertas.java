...
public class VerOfertas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerOfertas);
        ...
        adaptaer.setOnclickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "selecciona:" + tarjetas.
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    VerOfertas.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
    ...
    private void traerImagenes(int idOferta, int i) {
        ...
        if (checkPermissionREAD_EXTERNAL_STORAGE(VerOfertas.this)) {
            checkPermissionREAD_EXTERNAL_STORAGE(VerOfertas.this);
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(VerOfertas.this, "GET_ACCOUNTS Denied",
    ...
    private void abrirDialogDescripcion(View v) {
        ...
        enviarMensaje.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent conversar= new Intent(VerOfertas.this, Conversacion.class);
